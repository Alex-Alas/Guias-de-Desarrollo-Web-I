...
//Esta variable almacena el carnet del estudiante que se está editando
...
function guardarEstudiante() {
    ...
    if (carnetEditando) {  // Verificar si estamos en modo edición
    ...
    else { // Si estamos en modo inserción
